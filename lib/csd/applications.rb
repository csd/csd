...
module CSD
  ...
  class Applications
    ...
    def self.find(app_name)
      return nil if app_name.empty?
      UI.debug "Applications.find: Request for searching Application `#{app_name}´"
      begin
        ...
        UI.debug "Applications.find: Successfully loaded `#{app_name}´."
      rescue LoadError => e
